"object" == typeof navigator && function (e, t) {
                ...
                if (this.isHTML5) {
                    ...
                    Object.defineProperty(e.media, "quality", {
                        ...
                        set: function (t) {
                            ...
                            if (e.config.hasOwnProperty('customQualityFunction') && typeof e.config.customQualityFunction === 'function') {
                                e.config.customQualityFunction(t);
                            }
    ...
    function ae(e, t) {
        if (m.string(e)) {
            var n = m.string(t),
                ...
                a = function (e, t) {
                    e.innerHTML = t, e.setAttribute("aria-hidden", "true"), Array.from(e.querySelectorAll("svg")).forEach(function (e) {
    ...
    var he = {
        ...
        pe = {
            ...
            quality: {
                default: -1,
                options: [4320, 2880, 2160, 1440, 1080, 720, 576, 480, 360, 240, -1]
            },
            loop: {
                active: !1
            },
            ...
            i18n: {
                restart: "התחלה מחדש",
                rewind: "חזרה {seektime} שניות",
                play: "ניגון",
                pause: "השהיה",
                fastForward: "קדימה {seektime} שניות",
                seek: "התקדמות הנגן",
                ...
                mute: "השתקה",
                unmute: "ביטול השתקה",
                enableCaptions: "הפעלת כתוביות",
                disableCaptions: "כיבוי כתוביות",
                download: "הורדה",
                enterFullscreen: "כניסה למסך מלא",
                exitFullscreen: "יציאה ממסך מלא",
                frameTitle: "נגן מדיה: {title}",
                captions: "כתוביות",
                settings: "הגדרות",
    ...
    var Ee = {
        ...
        setTitle: function () {
            ...
            if (m.string(this.config.title) && !m.empty(this.config.title) && (e += ", ".concat(this.config.title)), Array.from(this.elements.buttons.play || []).forEach(function (t) {
                ...
                t.setAttribute("title", i.replace("{title}", n)), "-1" === t.getAttribute("tabindex") && t.removeAttribute("tabindex")
            }
        },
